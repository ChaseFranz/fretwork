...
# The fork's identity columns: written on every sheet, hidden in Excel, a hash
# means nothing to a reader (instruments.FORK_ID_COLS).
HIDDEN_COLS = list(instruments.FORK_ID_COLS)
...
def style_sheet(ws, df, sheet_name):
    ...
    hidden_cols = [*profile.hidden_cols, *HIDDEN_COLS]
    wb = ws.parent
