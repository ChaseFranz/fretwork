...
**Status:** Ready. Written 2026-09-12 against `main` at `e23f592`, from the code and measurements of the Local library in headless Chrome (node counts and pixel heights; the timings are step 1, since the harness's virtual clock does not advance while a script runs).
