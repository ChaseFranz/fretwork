...
| 25 | [The ladder: every song page links its neighbours](25-ladder.md) | Landed (2026-09-19, e7153b6..176fe50; tag fretladder-v1.8.0, deployed 2026-09-19 20:55 -0500) | S | 24 | From the first Search Console report (discovered, not crawled) and a panel over it: every song page ranks itself among the site's songs and its source's on its primary Expert part, says its notes and length, and links the two songs above and below on each and the artist's other songs, all from the data; the picture's real size; the live check reads the ladder. Rejected the sitemap split (no crawl effect), prose per song and a noindex on the tail. |
