...
**Status:** Landed (2026-09-12, on `main`; awaiting the maintainer's deploy). Written 2026-09-12 against `main` at `47e6240`, from the maintainer's question "what else do we need to do to improve SEO", after 21 had made the site readable.
